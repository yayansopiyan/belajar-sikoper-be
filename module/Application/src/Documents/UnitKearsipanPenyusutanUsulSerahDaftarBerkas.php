...
use Application\Documents\UnitKearsipanPenyusutanUsulSerah;
use DateTime;
...
/**
 * @ODM\Document(collection="unit_kearsipan_penyusutan_usul_serah_daftar_berkas")
 *
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class UnitKearsipanPenyusutanUsulSerahDaftarBerkas
{
    /**
     * @ODM\Id
     *
    ...
    /**
     * @ODM\ReferenceOne(targetDocument="Application\Documents\UnitKearsipanPenyusutanUsulSerah")
     *
     * @var object
     */
    private $usulSerah;
    ...
    public function getUsulSerah(): object
    {
        return $this->usulSerah;
    }

    public function setUsulSerah(UnitKearsipanPenyusutanUsulSerah $usulSerah): void
    {
        $this->usulSerah = $usulSerah;
    }
