...
use Application\Documents\UnitPengolah;
use DateTime;
...
/**
 * @ODM\Document(collection="unit_pengolah_lokasi_penyimpanan")
 *
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class UnitPengolahLokasiPenyimpanan
{
    /**
     * @ODM\Id
     *
    ...
    public function getUnitPengolah(): UnitPengolah
    {
        return $this->unitPengolah;
    }

    public function setUnitPengolah(UnitPengolah $unitPengolah)
    {
