...
/**
 * @ODM\Document(collection="unit_pengolah_transaksi_peminjaman")
 *
 * @Gedmo\SoftDeleteable(fieldName="deletedAt", timeAware=false)
 */
class UnitPengolahTransaksiPeminjaman
{
    /**
     * @ODM\Id
     *
    ...
    /**
     * @ODM\ReferenceOne(targetDocument="Application\Documents\UnitPengolahPeminjam")
     *
     * @var object
     */
    private $peminjam;
